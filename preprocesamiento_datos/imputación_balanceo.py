...
#df_balanced.to_csv('df_output/balanceado_sinfaltantes.csv',index=False)

#se aplican otros metodos de imputacion de datos para el dataframe sin datos faltantes, luego se codifican
df_sin_faltantes